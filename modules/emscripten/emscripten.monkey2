...
Function emscripten_run_script:Void( script:Utf8String )
Function emscripten_run_script_int:Int( script:Utf8String )
Function emscripten_run_script_string:Utf8String( script:Utf8String )
Function emscripten_async_run_script:Void( script:Utf8String,millis:Int )
Function emscripten_async_load_script:Void( script:Utf8String,onload:em_callback_func,onerror:em_callback_func )
