...
Class HtmlViewExt Extends ScrollableView
	...
	Method New()
		...
		_container=New document_container_ext( Self )
...
#Endif
	...
	Method OnRenderContent( canvas:Canvas ) Override
		...
		clip.x=VisibleRect.X
		clip.y=VisibleRect.Y
		clip.width=VisibleRect.Width
...
Class document_container_ext Extends litehtml.document_container

	Field _view:HtmlViewExt
